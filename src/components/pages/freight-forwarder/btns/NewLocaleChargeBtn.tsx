...
const itemsMenu = [
  {
    title: "Create new Local Charge",
    icon: <Plus color="#191919" size={15} />,
    href: "/new-local-charge?unitOfMeasure=perflat&mode=1",
  },
  {
    title: "Upload rates",
    icon: <CloudUpload size={15} />,
    href: "local-charge/upload-rates",
  },
];
...
export default function NewLocaleChargeBtn() {
  return (
