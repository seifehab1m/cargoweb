...
const itemsMenu = [
  {
    title: "Create new General Charge",
    icon: <Plus color="#191919" size={15} />,
    href: "/new-general-charge?unitOfMeasure=perflat&mode=1",
  },
  {
    title: "Upload rates",
    icon: <CloudUpload size={15} />,
    href: "/general-charge/upload-rates",
  },
];
...
export default function NewGeneralChargeBtn() {
  return (
