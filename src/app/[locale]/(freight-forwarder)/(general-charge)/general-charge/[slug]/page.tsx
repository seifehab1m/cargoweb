  ...
  return (
    <div className="container py-10">
      <ViewSinglePageDetailsHeader
        ...
        title="View General Charge"
        service={service}
        fetchpageDetails={fetchService}
        urlActivate="/tazamun-freight-forwarder/api/v1/GeneralCharges/active/"
        urlDeactivate="/tazamun-freight-forwarder/api/v1/GeneralCharges/InActive/"
      />
